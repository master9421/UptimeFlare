...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/master9421', label: 'GitHub' },
    { link: 'https://winteroften.sldblog.top/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '博客总入口（自动分流）',
      method: 'HEAD',
      target: 'https://winteroften.sldblog.top/',
      statusPageLink: 'https://winteroften.sldblog.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      method: 'HEAD',
      target: 'https://eo.sldblog.top/',
      statusPageLink: 'https://eo.sldblog.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <alert@update.winteroften.top>",
        "to": ["maotouyee@outlook.com"],
